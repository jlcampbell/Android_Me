...
public class BodyPartFragment extends Fragment {
    ...
    // c (1) Create a setter method and class variable to set and store of a list of image resources
    private List<Integer> imageResources;

    public void setImageResources(List<Integer> images){
    ...
    public void setListItemIndex(int itemIndex){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(imageResources != null){
            imageView.setImageResource(imageResources.get(listItemIndex));
        } else {
